...
$database_type     = 'mysql';
$database_default  = $_ENV['CACTI_DB_NAME'];
$database_hostname = $_ENV['CACTI_DB_HOST'];
$database_username = $_ENV['CACTI_DB_USER'];
$database_password = $_ENV['CACTI_DB_PASS'];
$database_port     = $_ENV['CACTI_DB_PORT'];
$database_retries  = 5;
$database_ssl      = false;
$database_ssl_key  = '';
$database_ssl_cert = '';
...
if (true !== empty($_ENV['CACTI_RDB_NAME'])) {
    $rdatabase_type     = 'mysql';
    $rdatabase_default  = $_ENV['CACTI_RDB_NAME'];
    $rdatabase_hostname = $_ENV['CACTI_RDB_HOST'];
    $rdatabase_username = $_ENV['CACTI_RDB_USER'];
    $rdatabase_password = $_ENV['CACTI_RDB_PASS'];
    $rdatabase_port     = $_ENV['CACTI_RDB_PORT'];
    $rdatabase_retries  = 5;
    $rdatabase_ssl      = false;
    $rdatabase_ssl_key  = '';
    $rdatabase_ssl_cert = '';
...
$poller_id = $_ENV['CACTI_POLLER_ID'];
...
if (true !== empty($_ENV['CACTI_COOKIE_DOMAIN'])) {
    $cacti_cookie_domain = $_ENV['CACTI_COOKIE_DOMAIN'];
}
...
$scripts_path = '/usr/local/cacti/scripts';
$resource_path = '/usr/local/cacti/resource/';
...
//$input_whitelist = '/usr/local/cacti/etc/input_whitelist.json';
...
$path_csrf_secret = '/usr/local/cacti/etc/csrf-secret.php';
 ...
 */
if (file_exists('/usr/local/cacti/etc/config.user.php')) {
    include_once '/usr/local/cacti/etc/config.user.php';
}
